...
export const metadata: Metadata = {
  ...
  description:
    "Contact ZANZIONE TOURS & SAFARIS in Shangani, Stone Town, Zanzibar. WhatsApp: +255 710 885 320, Call: +255 773 929 583, Email: zanzionetoursandtravel@mail.com. Available 24/7 for tour bookings and travel planning.",
  keywords:
