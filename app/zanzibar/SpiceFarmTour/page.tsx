...
export const metadata: Metadata = {
  ...
  description: "Discover why Zanzibar is called the Spice Island. Walk through spice plantations, taste and smell exotic spices including turmeric, cinnamon, cloves, and nutmeg.",
}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-2xl text-white/90 mb-8">
                Experience, Taste, and Smell the Spice Island
              </p>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Zanzibar is famously known as the "Spice Island" due to its rich cultivation of various spices. Join us for an approximate <strong>2-hour walking trip</strong> with an expert local guide to dive into the world of tropical fruits and spices.
                  </p>
                  <p className="font-semibold text-blue-season">This tour is a feast for the senses, allowing you to:</p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Explore Nature:</strong> Enjoy a unique walk through the rainforest-like environment with tropical plants and trees</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Taste and Smell:</strong> Experience, taste, and smell numerous spices grown in Zanzibar, including Turmeric, Cardamom, Cinnamon, Black Pepper, Cloves, and Nutmegs</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Cultural Experience:</strong> Learn more about the local culture and traditions surrounding these valuable herbs and spices</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Refreshments:</strong> Drink fresh coconut juice directly from the local farm</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Lunch & Shopping:</strong> The tour concludes with a delicious Spiced Rice (Pilau) Lunch paired with tropical fruits. You will also have the opportunity to buy fresh spices at the farm</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded">
                    ...
                    <p className="text-amber-800 text-sm">
                      Please be aware that the price for this tour does <strong>not</strong> include transportation costs. Since the final price depends on your hotel's location, kindly reach out to us, and we will provide you with the full price based on your accommodation details.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Spice Experts:</strong> All our local guides are from Zanzibar and have deep, firsthand knowledge of the spices and their traditional uses, which they are passionate about sharing</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Insider Access:</strong> We believe that only locals can truly show you Zanzibar as it is meant to be experienced, providing unique insights that enhance your journey</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-golden flex-shrink-0 mt-0.5" />
                      <span><strong>Multi-Lingual:</strong> Guides are skilled in multiple languages, including English, French, German, and Italian, ensuring you are comfortable and engaged throughout the tour</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
