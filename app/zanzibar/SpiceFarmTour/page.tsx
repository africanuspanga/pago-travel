...
export const metadata: Metadata = {
  title: "Spice Farm Tour - Experience the Spice Island | Pago Travel Experience",
  description:
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded">
                    ...
                    <p className="text-amber-800 text-sm">
                      Please be aware that the quote for this tour does <strong>not</strong> include transportation
                      costs. Since the final quote depends on your hotel's location, kindly reach out to us, and we will
                      provide you with the full quote based on your accommodation details.
                    </p>
                  </div>
                </CardContent>
              </Card>
