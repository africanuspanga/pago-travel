...
export const metadata: Metadata = {
  ...
  description: "Dive into Zanzibar's best snorkeling spot at Mnemba Island. Explore pristine coral reefs, swim with tropical fish, green turtles, and spot dolphins in this protected marine sanctuary.",
}
...
export default function MnembaIslandTourPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 w-full">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-white/90">
                Dive into Zanzibar's Best Snorkeling Spot
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="prose prose-lg max-w-none text-gray-700">
                  <p className="text-lg leading-relaxed mb-4">
                    Mnemba Island (sometimes called Mnemba Atoll) is renowned as one of the very best snorkeling spots in all of Zanzibar. Located off the northeast coast, this day trip is the easiest way to explore a truly spectacular underwater world.
                  </p>
                  <ul className="list-disc pl-6 text-lg space-y-2 mb-4">
                    <li><strong>Marine Paradise:</strong> Fishing is strictly forbidden near Mnemba Island, creating a thriving barrier reef ecosystem brimming with life.</li>
                    <li><strong>What to See:</strong> The underwater world is spectacular! You will snorkel with countless colorful tropical fish, sea creatures, and corals, including Starfishes, Moorish Idols, Snappers, and Green Turtles.</li>
                    <li><strong>Bonus Sightings:</strong> Occasionally, you might be lucky enough to spot dolphins during the trip!</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="prose prose-lg max-w-none text-gray-700">
                  <p className="text-lg leading-relaxed">
                    Mnemba is a small private island located about 3 km off Matemwe Beach on the northeast coast of Unguja (Zanzibar's main island). The island is surrounded by an oval reef, making it a conserved area for marine creatures and an ideal spot for snorkeling and scuba diving.
                  </p>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded">
                      <p className="text-sm text-gray-600">
                        <strong>Note:</strong> Transport costs to the departure point are excluded from the prices above. Contact us with your hotel location for the final price.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-blue-50 border-blue-200">
                  <CardContent className="p-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-blue-200">
                      <p className="text-sm text-gray-600">
                        <strong>Lunch Option (Extra Cost):</strong> Seafood BBQ Lunch (Octopus, Lobsters, Squids, Prawns, etc.) is available at an extra cost.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6 flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        The displayed price is <strong>exclusive of transport costs</strong> to the departure point (usually Matemwe/Muyuni). Please contact us with your hotel location, and we will provide you with the full, final price including hotel transfers.
                      </p>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div>
                <h2 className="text-3xl font-display font-bold text-blue-season mb-6">
                  Book Your Mnemba Adventure!
                </h2>
                <div className="prose prose-lg max-w-none text-gray-700">
                  <p className="text-lg leading-relaxed mb-4">
                    If you are looking for the best snorkeling experience in Zanzibar, look no further. Snorkeling near Mnemba is "insane" due to the high density of colorful fish species and healthy corals.
                  </p>
                  <ul className="list-disc pl-6 text-lg space-y-2">
                    <li><strong>Simple Booking:</strong> Booking is simple, just contact us today! We are happy to receive bookings well in advance.</li>
                    <li><strong>Contact:</strong> Use the "Ask on WhatsApp" button for immediate questions or to finalize your booking details.</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <Card className="sticky top-24 border-2 border-golden shadow-xl">
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="pt-4 border-t space-y-3">
                    <a
                      href="https://wa.me/255710885320?text=Hi, I'm interested in the Mnemba Island Snorkeling Tour"
                      target="_blank"
      ...
      {/* CTA Section */}
      <section className="bg-blue-season text-white">
        <div className="py-16">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Ready to Explore the Underwater Paradise?</h2>
