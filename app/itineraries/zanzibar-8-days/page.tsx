...
export default function Zanzibar8DaysPackage() {
  ...
  const whatsappMessage = `Hi, I'm interested in booking the ${packageName} ($1,350). Can you provide more details?`
                ...
                <Card className="border-2 border-[#3d1a14]">
                  <CardContent className="p-6">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-5xl font-bold text-[#3d1a14]">$1,350</p>
