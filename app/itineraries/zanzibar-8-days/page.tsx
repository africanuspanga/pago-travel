...
export default function Zanzibar8DaysPackage() {
  ...
  const whatsappMessage = `Hi, I'm interested in booking the ${packageName} ($1,340). Can you provide more details?`
                ...
                <Card className="border-2 border-blue-500">
                  <CardContent className="p-6">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-5xl font-bold text-blue-600">$1,340</p>
