...
export default function Zanzibar5DaysPackage() {
  ...
  const packageName = "Zanzibar 5 Days 4 Nights Package"
  const whatsappMessage = `Hi, I'm interested in booking the ${packageName} ($740). Can you provide more details?`
                ...
                <Card className="border-2 border-blue-500">
                  <CardContent className="p-6">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-5xl font-bold text-blue-600">$740</p>
